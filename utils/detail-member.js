          ...
          <div class="md:flex">
            ...
            <div class="md:w-2/3 p-6">
              <div class="flex items-center justify-between mb-4">
                <div>
                  <h1 class="text-2xl font-bold text-gray-900">${memberData.name}</h1>
                  <p class="font-semibold text-blue-300 mt-1">${jikoMember ? jikoMember.nicknames : 'Tidak tersedia'}</p>
                </div>
                <div class="flex space-x-4">
                  ${memberData.socialMedia?.twitter ? `
                  <a href="${memberData.socialMedia.twitter}" target="_blank" 
                  ...
                  <a href="${memberData.socialMedia.instagram}" target="_blank" 
                  ...
                  <a href="${memberData.socialMedia.tiktok}" target="_blank" 
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div class="space-y-3">
                  <p class="text-gray-700"><span class="font-semibold">Tanggal Lahir:</span> ${memberData.birthdate || 'Tidak tersedia'}</p>
                  <p class="text-gray-700"><span class="font-semibold">Golongan Darah:</span> ${memberData.bloodType || 'Tidak tersedia'}</p>
                  <p class="text-gray-700"><span class="font-semibold">Zodiak:</span> ${memberData.zodiac || 'Tidak tersedia'}</p>
                  <p class="text-gray-700"><span class="font-semibold">Tinggi:</span> ${memberData.height || 'Tidak tersedia'}</p>
                </div>
                <div class="bg-blue-200/30 p-4 rounded-lg">
                  <p class="text-gray-700 italic">${jikoMember ? jikoMember.jikosokai : 'Tidak tersedia'}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    container.innerHTML = `
      <div class="max-w-6xl mx-auto p-6">
        <div class="bg-white rounded-xl shadow-lg p-6 text-center">
          <p class="text-red-500 text-lg">Gagal memuat detail member. Silakan coba lagi nanti.</p>
        </div>
      </div>`;
  }
}
