...
async function fetchDetailMember() {
  ...
  <div class="space-y-2 mt-4 flex flex-col md:flex-row md:space-x-4 md:space-y-0 justify-center items-center">
    ...
    }" target="_blank" class="text-blue-500 text-2xl mx-2 flex justify-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="49" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
